...
private:
    ...
    std::map<FBTypes, XMLValue> fbValues_ = {
        ...
        { FBTypes::eCANOPY_LADDER_FUELS_TYPE,
            XMLValue("/FCCS_file/fuelbed/canopy/ladder_fuels/type",UnitTypes::eNUMBER) },
        { FBTypes::eCANOPY_LADDER_FUELS_IS_VERTICALLY_CONTIGUOUS,
            XMLValue("/FCCS_file/fuelbed/canopy/ladder_fuels/is_vertically_contiguous",UnitTypes::eNUMBER) },
